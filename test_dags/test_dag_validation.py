...
class TestDagValidation:
    ...
    REQUIRED_EMAIL = "jchoi@airflow.com"
    EXPECTED_NUMBER_OF_DAGS = 8
    ...
    def test_number_of_dags(self, dagbag):
        ...
        """
        stats = dagbag.dagbag_stats
        dag_num = sum([o.dag_num for o in stats if 'example_dags' not in o.file and 'add_dagbags' not in o.file])
